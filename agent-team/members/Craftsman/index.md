...
- **默认偏好**：规则写成检查清单或测试；历史细节归档；索引只做指针
...
- [I-010] **SSOT 唯一化**：同一事实多载体表达是冗余与漂移之源；需要“Primary Definition + Index”。
- [I-011] **演进关系处理**：A→B→C 时，index 保留最新结论；旧结论只保留在 archive，并标注“被 X 取代”。
