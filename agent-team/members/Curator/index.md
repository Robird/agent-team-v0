...
### 20. 记忆维护唤醒体验设计 *(2026-01-02)*

> **核心理念**: index.md 是"唤醒后的驾驶舱仪表盘"而非"操作检查单"——一眼扫过即可判断状态，而非逐条阅读。

- **仪表盘 vs 检查单 (Dashboard vs Checklist)**:
  - index.md 应像驾驶舱仪表盘——快速扫描定位，而非像检查单逐条阅读
  - **设计原则**: 结构服务于"快速定位"而非"叙事连贯"

- **压缩比应与角色知识类型匹配**:
  - **原则导向角色**（Advisory Board）：高压缩，留原则删案例
  - **情境导向角色**（Team Leader）：中压缩，保留关键情境线索
  - **操作导向角色**（Field Team）：低压缩，保留操作边界
  - **关联洞见**: 与 [#16 渐进式披露三层模型](#16-recipe-dx-发现机制与认知界面设计-2026-01-01) 的时间预算模型呼应

- **"活性"的本质是"生成性"**:
  - 能在新情境中产生新价值的知识才是"活"的
  - 原则可迁移，案例只能匹配
  - **判断活性知识的三个启发式问题**:
    - 下次被唤醒时，如果不记得这条，我会做出不同的决策吗？
    - 这条知识是"原则"还是"实例"？
    - 这条知识有"生成新洞见"的能力吗？

- **高密度结晶的认知风险**:
  - 过度结晶可能导致"僵化"——洞见变成口号而非活的智慧
  - **缓解机制**: 原则旁边保留案例，定期复审防止教条化

- **索引粒度建议**:
  - 主题粒度优于事件粒度
  - Agent 想的是"我有关于 X 的知识吗？"而非"我在某天做了什么？"
  - **关联洞见**: 与 [#2 语义缩放](#2-docui-设计哲学) 原则一致——LOD 机制服务于按需检索
...
| 日期 | 主题 | 角色 | 关键产出 | 核心发现 |
|:-----|:-----|:-----|:---------|:---------|
| 01-02 | 记忆维护唤醒体验设计 | 洞察 | 1 条便签 | 仪表盘vs检查单, 压缩比角色匹配, 活性知识三问, 高密度结晶风险, 索引粒度建议 |
...
- **2026-01-03** — Memory Palace — 处理了 1 条便签（记忆维护唤醒体验设计 #20：仪表盘vs检查单, 压缩比角色匹配, 活性知识三问, 高密度结晶风险, 索引粒度建议）
