...
34. **构成性 vs 规约性规则——系统提示词设计原则**（2025-12-30）
    ...
    - **压缩效果参考**：Advisor-DeepSeek 约 64% 压缩（280→101 行），Auditor 约 43% 压缩（180→102 行）
...
- **2025-12-30**: Memory Palace — 处理了 1 条便签（构成性 vs 规约性规则——系统提示词重写实践，Advisor-DeepSeek/Auditor 提示词压缩完成）
