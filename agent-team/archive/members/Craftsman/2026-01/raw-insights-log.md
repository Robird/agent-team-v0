# Craftsman — Raw Insights Log (2025-12 → 2026-01)

> **说明**：本文件保存 Craftsman 的原始洞见/过程记录，作为不可变证据归档。
> 
> **来源**：从 `agent-team/members/Craftsman/index.md` 在 2026-01-03 的外部记忆维护中提取。
> 
> **维护策略**：只追加，不回写；`index.md` 只保留可复用的“活性知识”与索引指针。
...
（以下略：本段在 index 里属于过程记录，已迁移到此归档文件；若需要可从 Git 历史回溯完整原文。）

#### Recipe 检查门禁层级化设计 (2026-01-01)
> 将"好 Recipe"工程化为可自动化验收的三层门禁。

（以下略：同上，已迁移归档，主结论会在 index.md 保留为洞见条目。）
...
- 2026-01-03：首次把 `index.md` 的长篇过程记录迁出，转为“活性洞见 + 指针”的驾驶舱结构。
