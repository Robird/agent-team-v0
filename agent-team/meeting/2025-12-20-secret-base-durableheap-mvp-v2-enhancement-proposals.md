...
> 这是有意为之的简化设计。如果用户需要完整历史审计能力，应在执行
> Checkpoint 前归档原始文件。
...
- [S-CB-05] 若实现提供“生成 checkpoint”的 API，则该操作 **MAY** 允许丢弃（或变得不可达）更早版本历史；规范不要求“跨 checkpoint 的审计连续性”。
