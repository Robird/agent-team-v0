...
> **参与成员**：Advisor-Claude, Advisor-GPT, Advisor-Gemini  
> **状态**：待畅谈与修订
...
**提出者**：Advisor-Claude, Advisor-Gemini  
**优先级**：HIGH
...
| 等级 | 密度 | 特征 | 示例 |
|:-----|:-----|:-----|:-----|
| 🌟 极高密度 | > 4% | "参考手册"风格，纯原则 | Gemini: 15 洞见 / 144 行 = 10.4% |
...
- **高密度型 Agent**（如 Advisor-Gemini）：优先"提纯为原则"，行数可低至 150-200
...
**第一级**：按时间保留完整原始记录
```
archive/members/Advisor-Gemini/2025-12/
  └── raw-insights-log.md  # 完整保留所有被压缩的内容
```

**第二级**（未来执行）：按主题重组
```
archive/members/Advisor-Gemini/by-topic/
  ├── ux-dx-principles.md
  ├── docui-design.md
...
- [ ] **Advisor-Gemini 的"高密度结晶"模式**：是否值得推广？
...
- [Advisor-Gemini 维护日志](../../members/Advisor-Gemini/maintenance-log.md)
