...
#### 准备阶段要点
- **确定范围**：明确维护哪些记忆文件
- **创建备份**：Git commit或Archive快照
- **列出不可删除项**：核心洞见、生效决策、外部引用锚点

#### 执行阶段要点
- **分类扫描**：使用`[I]`(Identity)、`[S]`(Insight)、`[X]`(Index)、`[A]`(Archive)标记
- **洞见提纯**：从Index中提取跨时间可复用的知识到Insight层
- **过程压缩**：将过程记录压缩为索引条目
- **过时处理**：过时信息标记deprecated或移除
