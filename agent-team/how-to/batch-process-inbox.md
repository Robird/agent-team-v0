...
> **已迁移**：小黑板维护拆分为独立的阶段2，见 `maintain-blackboard.md`。
> 
> 阶段1 完成后，产出报告到 `handoffs/memory/`，等待监护人触发阶段2。
...
| 日期 | 变更 |
|:-----|:-----|
| 2026-01-05 | v4.2: 合并 Step 3 和 Step 5 为统一报告；明确输出文件名 `YYYY-MM-DD-HHmm-batch.md`；MPK prompt 补充小黑板候选要求 |
| 2026-01-05 | v4.1: 二阶段拆分——小黑板维护迁移到 `maintain-blackboard.md`；报告增加「小黑板候选汇总」和「便签主题分布」章节 |
