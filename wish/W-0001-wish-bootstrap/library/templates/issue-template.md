...
> **使用方法**：在 Wish 实例目录的 `project-status/issues.md` 中添加 Issue 条目。
...
|:--------|:-----|:-----|:------------|:------|:-----|:---------|:------------|
| I-0001  | Rule-Tier | Open | W-0001      | @role | ... | —        | YYYY-MM-DD  |
```
...
| 层级 | ✅ | Resolve-Tier / Shape-Tier / Rule-Tier / Plan-Tier / Craft-Tier，表示问题所属层级 |
